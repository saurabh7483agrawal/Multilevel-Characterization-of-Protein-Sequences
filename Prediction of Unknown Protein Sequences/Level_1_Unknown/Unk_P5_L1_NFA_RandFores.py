# -*- coding: utf-8 -*-
"""
Created on Fri Mar 26 12:35:39 2021
...
df = pd.read_csv("Train_Level_1_GP_NonGP.csv")
X=df.iloc[:,1:311]
y=df.iloc[:,311]
...
df.head()
Z_res_train, Z_res_test, Y_res_train, Y_res_test = train_test_split(Z_res, Y_res, test_size=0.1, random_state=0)  
...
test = pd.read_csv("Unk_Test_NFA_Level_1_GP_NonGP.csv")
