# -*- coding: utf-8 -*-
"""
Created on Sat Mar 27 11:28:34 2021
...
# dataload
data = pd.read_csv("Train_Level_4_a_Path_StaAu_PSL_1_2_3.csv") 
X=data.iloc[:,1:311]
Y=data.iloc[:,311]
plt.figure()
...
test = pd.read_csv("Unk_NFA_Test_Level_4_a_Path_StaAu_PSL_1_2_3.csv")
